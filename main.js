...
//remote:
app.use(express.static(path.join(__dirname, '../assignment3-3-206934978_314978198/dist')));
app.get("/",function(req,res)
{ 
  //remote: 
  res.sendFile(path.join(__dirname, '../assignment3-3-206934978_314978198/dist/index.html'));
  //local:
